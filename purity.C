...
h2->SetTitle("");
h2->GetXaxis()->SetTitle("#tau_{h} P_{T} [GeV]");
...
TLatex *   tex = new TLatex(20.55353,1.855099,"CMS");
   tex->SetTextAlign(20);
   //tex->SetTextSize(0.045);
   tex->SetLineWidth(2);
   tex->Draw();
TLatex *   tex1 = new TLatex(27.98829,1.752609,"#it{#bf{work in progress}}");
...
c1->SaveAs("plots/JetpT_purity_tight_14Sept.root");
c1->SaveAs("plots/JetpT_purity_tight_14Sept.png");
